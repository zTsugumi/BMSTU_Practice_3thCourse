...
\COPY faculties (name, course) FROM 'faculties.csv' DELIMITER ',' CSV HEADER;
\COPY groups (faculty_id, name) FROM 'groups.csv' DELIMITER ',' CSV HEADER;
\COPY subjects (name) FROM 'subjects.csv' DELIMITER ',' CSV HEADER;
\COPY classrooms (room_nr, start_time, para) FROM 'classrooms.csv' DELIMITER ',' CSV HEADER;
-- \COPY classes (subject_id, classroom_id, group_id, day, start_time, class_type) FROM 'classes.csv' DELIMITER ',' CSV HEADER;
\COPY faculty_subject (faculty_id, subject_id) FROM 'fac_sub.csv' DELIMITER ',' CSV HEADER;
